...
export GITHUB_EVENT_PATH="actions/changed-roots/scripts/payload.json"
...
node actions/changed-roots/dist/index.js

# echo "Summary Output: $tmp_file"
# cat "$tmp_file"
# echo "Writing to table.md"
# cat "$tmp_file" > actions/changed-roots/table.md
