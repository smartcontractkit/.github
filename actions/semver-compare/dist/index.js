...
// actions/semver-compare/src/run.ts
...
function versionCompare(version1, operator, version2) {
  ...
  if (!import_semver.default.valid(version1) || !import_semver.default.valid(version2)) {
    throw new Error("Invalid version(s).");
  }
  if (!["gt", "lt", "eq"].includes(operator)) {
    throw new Error("Invalid operator.");
  }
  const result = import_semver.default[operator](version1, version2);
  return result;
}

// actions/semver-compare/src/index.ts
run();
